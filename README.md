...
docker images
```
If you see installed docker image, you are good to go to next step. Using visual studio code or any IDE, open docker/start_cpu_docker.sh file. 
...
If you can see both the folders mentioned above, you are good to go!
...
***Step 4:*** Run the docker image using the method mentioned above in this readme file. While running docker or Singularity make sure that you mount this repo and the path of the hypersim data. Depending on the path you mounted the repo and data, datapaths will be different inside docker image.
